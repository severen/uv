...
fn emit_marker_expression_exciting_linux() -> Result<()> {
    ...
    #    python_full_version == '3.12.4' and platform_python_implementation == 'CPython' and platform_system == 'Linux'
    anyio==4.3.0
        # via -r requirements.in
    idna==3.6
        # via anyio
...
fn emit_marker_expression_direct() -> Result<()> {
    ...
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --emit-marker-expression
    # Pinned dependencies known to be valid for:
    #    python_full_version == '3.12.4' and platform_python_implementation == 'CPython' and platform_system == 'Linux' and sys_platform == 'linux'
    anyio==4.3.0
        # via -r requirements.in
    idna==3.6
        # via anyio
...
fn emit_marker_expression_pypy() -> Result<()> {
    ...
    #    uv pip compile --cache-dir [CACHE_DIR] requirements.in --emit-marker-expression
    # Pinned dependencies known to be valid for:
    #    python_full_version == '3.12.4' and implementation_name == 'cpython'
    pendulum==3.0.0
        # via -r requirements.in
